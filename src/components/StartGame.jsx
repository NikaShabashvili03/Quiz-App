...
export const StartGame = ({score,categorypercentage,stepCategory,setStepCategory,setScore}) => {
    return(
        <div className='App'>
            <div className='count'>
            ...
            <div className='categorylist'>
                {questions.map(list => <Category categorypercentage={categorypercentage} stepCategory={stepCategory} setStepCategory={setStepCategory} score={score} setScore={setScore} category={list}/>)}
            </div>
        </div>
    );
}